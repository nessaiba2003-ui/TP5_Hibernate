...
public class App {
    ...
    private static void initializeTestData(EntityManager em) {
        ...
        Utilisateur user1 = new Utilisateur("Layla", "Bouaabid", "Layla.bouaabid@example.com");
